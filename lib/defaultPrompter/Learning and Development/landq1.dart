...
import 'dart:async';
import 'landq2.dart';
class LandQ1 extends StatefulWidget {
  const LandQ1({Key? key}) : super(key: key);

  @override
  State<LandQ1> createState() => _LandQ1State();
}

class _LandQ1State extends State<LandQ1> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text('Why did the sharer choose this skill as the most confident skill and why did the learner wants to improve this skill?',
          ...
          ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => LandQ2()),
                );
              },
