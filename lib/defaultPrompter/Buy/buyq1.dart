...
import 'dart:async';
import 'buyq2.dart';
class BuyQ1 extends StatefulWidget {
  const BuyQ1({Key? key}) : super(key: key);

  @override
  State<BuyQ1> createState() => _BuyQ1State();
}

class _BuyQ1State extends State<BuyQ1> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("What is the key problem that you are facing currently?",
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => BuyQ2()),
                    );
                  },
