...
import 'dart:async';
import 'buyq4.dart';
class BuyQ3 extends StatefulWidget {
  const BuyQ3({Key? key}) : super(key: key);

  @override
  State<BuyQ3> createState() => _BuyQ3State();
}

class _BuyQ3State extends State<BuyQ3> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("In order to get to that outcome, what do we need to do, what resources need to be invested and any other changes to be made?",
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => BuyQ4()),
                    );                    },
