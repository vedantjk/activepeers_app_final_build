...
class BuyQ4 extends StatefulWidget {
  const BuyQ4({Key? key}) : super(key: key);

  @override
  State<BuyQ4> createState() => _BuyQ4State();
}

class _BuyQ4State extends State<BuyQ4> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("Is there a willingness to take that action to get towards that outcome? ",
