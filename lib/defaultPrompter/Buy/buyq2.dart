...
import 'dart:async';
import 'buyq3.dart';
class BuyQ2 extends StatefulWidget {
  const BuyQ2({Key? key}) : super(key: key);

  @override
  State<BuyQ2> createState() => _BuyQ2State();
}

class _BuyQ2State extends State<BuyQ2> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("If that problem was solved, what impact would it have? ",
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => BuyQ3()),
                    );                  },
