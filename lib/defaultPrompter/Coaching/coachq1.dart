...
import 'dart:async';
import 'coachq2.dart';
class CoachQ1 extends StatefulWidget {
  const CoachQ1({Key? key}) : super(key: key);

  @override
  State<CoachQ1> createState() => _CoachQ1State();
}

class _CoachQ1State extends State<CoachQ1> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text('What would be the outcome if this session/series was a huge success? How would we know if this happened? ',
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => CoachQ2()),
                    );
                  },
