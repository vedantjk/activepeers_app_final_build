...
class CoachQ4 extends StatefulWidget {
  const CoachQ4({Key? key}) : super(key: key);

  @override
  State<CoachQ4> createState() => _CoachQ4State();
}

class _CoachQ4State extends State<CoachQ4> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("What is the worst that could happen and how could you handle it? What is the best that could happen and how could you handle it? ",
