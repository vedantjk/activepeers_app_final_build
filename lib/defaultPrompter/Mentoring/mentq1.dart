...
import 'dart:async';
import 'mentq2.dart';
class MentQ1 extends StatefulWidget {
  const MentQ1({Key? key}) : super(key: key);

  @override
  State<MentQ1> createState() => _MentQ1State();
}

class _MentQ1State extends State<MentQ1> {
            ...
            children: [
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => MentQ2()),
                    );
                  },
