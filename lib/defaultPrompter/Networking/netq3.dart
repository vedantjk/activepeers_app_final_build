...
import 'dart:async';
import 'netq4.dart';
class NetQ3 extends StatefulWidget {
  const NetQ3({Key? key}) : super(key: key);

  @override
  State<NetQ3> createState() => _NetQ3State();
}

class _NetQ3State extends State<NetQ3> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("What makes you/your product/your service different to others? Why would a client or employer choose what you do over others?",
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => NetQ4()),
                    );                    },
