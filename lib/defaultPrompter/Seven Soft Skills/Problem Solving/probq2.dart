...
import 'dart:async';
import 'probq3.dart';
class ProbQ2 extends StatefulWidget {
  const ProbQ2({Key? key}) : super(key: key);

  @override
  State<ProbQ2> createState() => _ProbQ2State();
}

class _ProbQ2State extends State<ProbQ2> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("What steps do you take before making a decision on how to solve a problem, and why?",
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ProbQ3()),
                    );                  },
