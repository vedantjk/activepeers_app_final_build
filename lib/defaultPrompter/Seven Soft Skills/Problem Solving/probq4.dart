...
class ProbQ4 extends StatefulWidget {
  const ProbQ4({Key? key}) : super(key: key);

  @override
  State<ProbQ4> createState() => _ProbQ4State();
}

class _ProbQ4State extends State<ProbQ4> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("Can you tell me about a situation where you overcame a problem using a creative solution?",
