...
class ConQ4 extends StatefulWidget {
  const ConQ4({Key? key}) : super(key: key);

  @override
  State<ConQ4> createState() => _ConQ4State();
}

class _ConQ4State extends State<ConQ4> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("How could you use a situation with conflict to have a better relationship with all involved?",
