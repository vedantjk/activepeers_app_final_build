...
import 'dart:async';
import 'leadq2.dart';
class LeadQ1 extends StatefulWidget {
  const LeadQ1({Key? key}) : super(key: key);

  @override
  State<LeadQ1> createState() => _LeadQ1State();
}

class _LeadQ1State extends State<LeadQ1> {
            ...
            children: [
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => LeadQ2()),
                    );
                  },
