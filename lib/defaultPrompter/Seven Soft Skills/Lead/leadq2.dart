...
import 'dart:async';
import 'leadq3.dart';
class LeadQ2 extends StatefulWidget {
  const LeadQ2({Key? key}) : super(key: key);

  @override
  State<LeadQ2> createState() => _LeadQ2State();
}

class _LeadQ2State extends State<LeadQ2> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("How do you describe your leadership style? ",
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => LeadQ3()),
                    );                  },
