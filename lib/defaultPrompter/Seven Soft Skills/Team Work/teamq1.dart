...
import 'dart:async';
import 'teamq2.dart';
class TeamQ1 extends StatefulWidget {
  const TeamQ1({Key? key}) : super(key: key);

  @override
  State<TeamQ1> createState() => _TeamQ1State();
}

class _TeamQ1State extends State<TeamQ1> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("How do you feel about working in a team? What do you think are the key things that need to happen to make good teamwork?",
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TeamQ2()),
                    );
                  },
