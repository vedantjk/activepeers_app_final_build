...
import 'dart:async';
import 'teamq4.dart';
class TeamQ3 extends StatefulWidget {
  const TeamQ3({Key? key}) : super(key: key);

  @override
  State<TeamQ3> createState() => _TeamQ3State();
}

class _TeamQ3State extends State<TeamQ3> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("How do you keep a team motivated? Share your story about a rewarding team experience.",
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TeamQ4()),
                    );                    },
