...
class IdeaQ4 extends StatefulWidget {
  const IdeaQ4({Key? key}) : super(key: key);

  @override
  State<IdeaQ4> createState() => _IdeaQ4State();
}

class _IdeaQ4State extends State<IdeaQ4> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex:1),
              Text("If any idea generated already in this discussion was to become a reality, what would be the impact on e year later in terms of benefits, ongoing coasts, sustained behavioural change and a launchpad for further growth?",
